const gameBox = document.getElementById("game");
      ...
      function handleMouseMove(mouseMoveEventObject) {
        ...
        // Your code here...
        coordsEl.innerHTML=`x=${mouseMoveEventObject.x},y=${mouseMoveEventObject.y}`;
        ...
        // back to "orange"
        if (mouseMoveEventObject.x > 200 && mouseMoveEventObject.x < 300 && mouseMoveEventObject.y>70 && mouseMoveEventObject.y<170) {
